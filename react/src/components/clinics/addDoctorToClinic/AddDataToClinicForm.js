...
import AsPerDate from "./AsPerDate";
import AsPerWeekly from "./doctorScheduleAsPerWeekly/AsPerWeekly";

const AddDataToClinicForm = (props) => {
  ...
  return (
    <>
<div className="row m-3 p-4 d-flex justify-content-evenly text-center">
...
export default AddDataToClinicForm;
