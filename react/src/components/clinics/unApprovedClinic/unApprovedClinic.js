...
import SingleClinicForApproved from "./SingleClinicForApproved";
  ...
  const getClinicsDate = async () => {
    try {
      const res = await axios.get(
        `/api/v1/admin/get/unapproved/clinic/${limit}/${page}`
      );
      // console.log("res", res);
...
export default UnApprovedClinic;
